...
#  save(object, file = "GA_intermediate_all_TestX0.5.Rdata")
...
GA.All.X0.5 <- ga(type = "real-valued", fitness = obj.fun.par, dm.data = dm.realization, test.total = dat.agg$Z*0.5, goal = "all", repi = repi, lower = rep(0, 21), upper = rep(1, 21),  keepBest = TRUE, popSize = 50, maxiter = 100, monitor = ga.monitornew, run = 100, pmutation = 0.05, suggestions = GA.sugguestion)

save(GA.All.X0.5, file = "Result\\Optimization\\GA_all_TestX0.5.Rdata")
